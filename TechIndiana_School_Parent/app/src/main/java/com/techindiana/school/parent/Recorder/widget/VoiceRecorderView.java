 ...
 */
package com.techindiana.school.parent.Recorder.widget;
...
import com.techindiana.school.parent.Recorder.core.VoiceRecorder;
import com.techindiana.school.parent.Recorder.utils.CommonUtils;
import com.techindiana.school.parent.Recorder.utils.EMError;
...
public class VoiceRecorderView extends RelativeLayout {
    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            // change image
            Random r = new Random();
            int count = r.nextInt((13 - 1)+1) + 1;
                micImage.setImageDrawable(micImages[count]);
