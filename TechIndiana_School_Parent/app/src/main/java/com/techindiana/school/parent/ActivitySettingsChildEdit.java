...
public class ActivitySettingsChildEdit extends BaseActivity implements DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivitySettingsChildEdit.this;
        ...
        try {
            ...
            actionBar.setTitle("Child Profile Edit");
        ...
        Methods.setFont(ActivitySettingsChildEdit.this, viewGroup);
        try {
            Declaration();
    ...
    private void Declaration() {
        try {
            ...
            for (int i = 0; i < Constant.settingInfochild.size(); i++) {
                if (Constant.childToBeEdit.equals(Constant.settingInfochild.get(i).getStudentId())) {
                    etFName.setText(Constant.settingInfochild.get(i).getFname());
                    etLName.setText(Constant.settingInfochild.get(i).getLname());
                    etDOB.setText(Constant.settingInfochild.get(i).getDob());
                    etRollNo.setText(Constant.settingInfochild.get(i).getRollNo());
                    etBloodGr.setText(Constant.settingInfochild.get(i).getBloodGrp());
                    if (Constant.settingInfochild.get(i).getGender().equals("male")) {
                        rbMale.isChecked();
                    } else {
                        rbFemale.isChecked();
                    }
                    Picasso.with(ActivitySettingsChildEdit.this).
            ...
            switch (v.getId()) {
                case R.id.sChdBtnSubmit:
                    if (etFName.getText().toString().trim().length() == 0) {
                        ...
                        new updateProfile(ActivitySettingsChildEdit.this).execute();
...
//                dialog.getDatePicker().setMaxDate(calendar.getTimeInMillis());
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jo_result.getString("success").equals("1")) {
                    Toast.makeText(ActivitySettingsChildEdit.this, "Child info updated successfully ....", Toast.LENGTH_LONG).show();
                    onBackPressed();
                }
        ...
        private String doFileUpload() {
            ...
            try {
              ...
              if(rbFemale.isChecked())
                 ...
                 reqEntity.addPart("student_id", new StringBody(Constant.childToBeEdit));
    ...
    private void choosProfileImg() {
        try {
            Typeface tf = Typeface.createFromAsset(ActivitySettingsChildEdit.this.getAssets(), getResources().getString(R.string.font_regular));
            final Dialog dialog = new Dialog(ActivitySettingsChildEdit.this);
                    ...
                    if (isReadStorageAllowed()) {
                        try {
                            ...
                            if (pictureIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Uri photoUri = FileProvider.getUriForFile(ActivitySettingsChildEdit.this, getPackageName() + ".provider", userImgPath);
    ...
    private boolean isReadStorageAllowed() {
        int result = ContextCompat.checkSelfPermission(ActivitySettingsChildEdit.this,
    ...
    private void requestStoragePermission(int i) {
        ...
        ActivityCompat.requestPermissions(ActivitySettingsChildEdit.this, new String[]{
        ...
        try {
            ...
            if (requestCode == 7) {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ActivitySettingsChildEdit.this, "Oops you just denied the permission",
            ...
            case 7:
                if (resultCode == RESULT_OK) {
                    ...
                    try {
                        ...
                        pathHolder = ActivitySettingsChildEdit.PathUtil.getPath(ActivitySettingsChildEdit.this, uri);
                        if (!new File(pathHolder).exists()) {
                            ...
                            Glide.with(ActivitySettingsChildEdit.this).
                                    load(uri1).
                        ...
                        e.printStackTrace();
                        Toast.makeText(ActivitySettingsChildEdit.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
                break;
                    ...
                    if (response.isSuccessful()) {
                        if (response.body().getSuccess().equals(Constant.RESP_SUCCESS)) {
                            ...
                            if (schoolNameInfos.size() > 0) {
                                ...
                                ArrayAdapter<String> adapterarrayCategory = new ArrayAdapter<String>(ActivitySettingsChildEdit.this,
                            ...
                            Toast.makeText(ActivitySettingsChildEdit.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    hideProgress();
                }
